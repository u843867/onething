				...
				<section id="content-wrapper" class="page">
					...
					<div <?php post_class("latest-small-article"); ?>>
						<div class="ls-article-inner">
							<div class="ls-image">
								<a href="<?php the_permalink(); ?>" class="tdonone">
								...
								<?php } else { 
									echo "<p class='inline_p'>"; 
									_e("No featured image added.", "cwp");
									echo "</p>";
								}?>
								<div class="ls-comments">
									<a href="<?php comments_link(); ?>"><h6><i class="icon-comments"></i>  <?php comments_number(__('No Comments','cwp'), __('One Comment','cwp'), __('% Comments','cwp')); ?></h6></a>
								</div><!-- end .ls-comments -->
								</a>
							</div><!-- end .ls-image -->
							<div class="ls-title">
