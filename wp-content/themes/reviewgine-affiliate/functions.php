...
function cwp_get_social_links()
	{
		$facebook_link = esc_url(cwp("cwp_social_facebook"));
		$twitter_link = esc_url(cwp("cwp_social_twitter"));
		$google_link = esc_url(cwp("cwp_social_google"));
		$pinterest_link = esc_url(cwp("cwp_social_pinterest"));
		$youtube_link = esc_url(cwp("cwp_social_youtube"));
...
// Custom admin styles
add_action( 'admin_enqueue_scripts', 'cwp_admin_custom_styles');
...
/* Custom CSS Code */
<?php echo esc_textarea(cwp('cwp_custom_css')); ?>
