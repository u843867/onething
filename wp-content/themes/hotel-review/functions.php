<?php
/**
 * hotels functions and definitions.
 *
...
if ( ! function_exists( 'hotel_review_setup' ) ) :
/**
...
function hotel_review_setup() {
	 ...
	 * If you're building a theme based on hotels, use a find and replace
	 * to change 'hotel-review' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'hotel-review', get_template_directory() . '/languages' );
...
function wpshout_custom_sizes( $sizes ) {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'hotel-review' ),
	) );
	/*
	...
	add_theme_support( 'custom-background', apply_filters( 'hotel_review_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // hotel_review_setup

add_action( 'after_setup_theme', 'hotel_review_setup' );
 ...
 */
function hotel_review_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'hotel_review_content_width', 640 );
}
add_action( 'after_setup_theme', 'hotel_review_content_width', 0 );
 ...
 */
function hotel_review_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'hotel-review' ),
		'id'            => 'sidebar-1',
		'description'   => '',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Widgets', 'hotel-review' ),
		'id'            => 'sidebar-2',
		'description'   => __('Widgets that will appear in the Footer area of the site.','hotel-review'),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
...
function hotel_review_scripts() {
        ...
        wp_enqueue_style('hotel-review-layoutstyle', get_template_directory_uri() . '/layouts/content-sidebar.css');
